...
gma20 = pd.read_csv("/home/ugur/Desktop/FS22/Databases/group-11/Datas/100097.csv", index_col=False, delimiter=';')
print(gma20.head(5))
...
try:
    ...
    if conn.is_connected():
        ...
        cursor.execute('DROP TABLE IF EXISTS gm2;')
        ...
        for i, row in gma20.iterrows():
            # here %S means string values
            sql = "INSERT INTO Project.gm2 VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s," \
                  "%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
